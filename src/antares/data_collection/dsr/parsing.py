...
from antares.data_collection.dsr.constants import DSR_INPUT_FILE, InputDsrColumns, OutputDsrColumns
from antares.data_collection.referential_data.main_params import MainParams
from antares.data_collection.thermal.constants import ANTARES_NODE_NAME_COLUMN
from antares.data_collection.thermal.utils import parse_input_file, filter_df_values_based_on_op_stat, \
    filter_non_declared_areas, filter_input_based_on_study_scenarios, \
    filter_thermal_input_file_based_on_commission_date, add_antares_cluster_name_colum, \
    filter_values_based_on_net_max_gen_cap, add_code_antares_colum
...
class DsrParser:
    ...
    def _computation_dsr_cluster(self, df: pd.DataFrame) -> pd.DataFrame:
    ...
    def _build_filtered_dsr_cluster_dataframe(self) -> pd.DataFrame:
        ...
        df = self._computation_dsr_cluster(df)
        return df
